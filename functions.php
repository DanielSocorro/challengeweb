...
function base_theme_setup()
{
	/*
		...
		*/
	load_theme_textdomain('challengeweb', get_template_directory() . '/languages');
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__('Primary', 'challengeweb'),
		)
	);
...
{
	wp_enqueue_style('base-theme-style', get_stylesheet_uri(), array(), challengeweb_VERSION);
	wp_style_add_data('base-theme-style', 'rtl', 'replace');

	wp_enqueue_script('base-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), challengeweb_VERSION, true);
